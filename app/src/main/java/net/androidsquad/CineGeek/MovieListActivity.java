...
import net.androidsquad.CineGeek.adapters.MovieRecyclerView;
import net.androidsquad.CineGeek.adapters.OnMovieListener;
import net.androidsquad.CineGeek.models.MovieModel;
import net.androidsquad.CineGeek.viewmodels.MovieListViewModel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        h.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                Intent i = new Intent(MovieListActivity.this , MovieListActivity.class);
                startActivity(i);
                finish();
